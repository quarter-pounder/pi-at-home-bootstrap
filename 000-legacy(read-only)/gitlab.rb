...
gitlab_rails['gitlab_email_display_name'] = ENV['SMTP_DISPLAY_NAME']
...
registry_external_url "http://#{ENV['DOMAIN']}:5050"
...
# Disable Let's Encrypt (Cloudflare tunnel handles TLS)
